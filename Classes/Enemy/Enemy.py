"""
This module contains Enemy Class and Enemy_Manager class. 
"""
...
class Enemy_Manager:
    ...
    def remove_attacked(self):
        """
        Decreasing the attacked_count if the enemy is attacked and removes the attacked state when the count reaches zero.
        """
    ...
    def remove_enemy(self): 
        """
        Removes the enemy from the present list if its life reaches zero.
        """
        if self.life == 0:
            Enemy_Manager.present.remove(self)
    ...
    def endlevel(cls):
        """
        Class method to clear all active enemies at the end of a level.
        """
        cls.present = []
